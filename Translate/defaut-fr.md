...
* `DEF-MY-COMPTE-LABEL`                   Mon compte
* `DEF-INTRO`                             Introduction
* `DEF-VISIT-SITE`                        Visiter le site
* `DEF-WELCOM`                            Bienvenue
* `DEF-MOD-EMPLOI`                        Mode d'emploi
* `DEF-PRESENTAT`                         Présentation
...
* `DEF-NOTICE`                            Annonce
* `DEF-CONTACT`                           Contact
* `DEF-CONTACT-INFO`                      Contact et information
...
* `BTC-PRICE-TITRE`                       Prix du Bitcoin
...
* `BTC-FORD-LABEL`                        La jeunesse qui pourra résoudre la question monétaire fera plus pour le monde que toutes les armées de l’histoire. Henry Ford
* `BTC-BLOCKCHAIN-LABEL`                  Blockchain est un portefeuille Web et mobile. La sauvegarde est automatique par mail. Authentification à 2 facteurs disponible.
